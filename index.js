...
[> Discord Server](https://discord.gg/HKjZbK8sE7)

[> Youtube Channel](https://youtube.com/channel/UCa2aSweV6rc2Wz0hfmsYQrw)`)
...
const callicolor    = "";
const calliimgae    = "";
const calliban      = "";                                                                                                                                                                             const securitybots = "Indocraft Security#5955";
const calliwarn     = "";                                                                                                                                                                             const callidevelopers = "823101214564417536"; const calliowner = "823101214564417536";
///////////////////////////////////////////////////////////////////////////////
calli.on("ready", () => {
...
[Youtube](https://youtube.com/OMITGAMING) **Bot Owner.**`);
    message.channel.send(help);
  }
});
///////////////////////////////////////////////////////////////////////////////
...
**report a problem**
If there is, you can always join the support server by type ${prefix}support. or DM a Developer. Developers you can message include【ᎮΩ】乛𓆩.ƘƖƝƓ.𓆪 🦋⃤ﮩ٨ـ♡ᴬᵏᵏᵘ#5929
**Extra Links**
[Support](https://discord.gg/b6wV94ZgrY) - [Invite](https://discord.com/api/oauth2/authorize?client_id=${calli.user.id}&permissions=8&scope=bot)`);
...
calli.on("guildCreate", guild => {
  let embed = new Discord.MessageEmbed()
    .setColor(`#589bff`)
    .setDescription(`Thanks for adding security, I wish you luck!MADE BY Omit Gaming`);
